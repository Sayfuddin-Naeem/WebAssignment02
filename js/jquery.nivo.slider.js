	...
	$.fn.nivoSlider = function(options) {
		...
		return this.each(function() {
			...
			kids.each(function() {
				...
				var childHeight = slider.height();
				if(childHeight == 0) childHeight = child.attr('height');
				//Resize the slider
				if(childWidth < slider.width() || childWidth > slider.width()){
					childWidth = slider.width();
				}
				if(childHeight < slider.height() || childHeight > slider.height()){
